...
const SVG_MAP = {
  ...
  compass: `<svg viewBox="0 0 24 24"${NS}><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="1.8"/><path fill="currentColor" d="M15.5 8.5l-2.4 5.6-5.6 2.4 2.4-5.6z"/>`,
  video: `<svg viewBox="0 0 24 24"${NS}><rect x="3" y="5" width="13" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="1.8"/><path fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" d="M16 10l5-3v10l-5-3"/>`
}
